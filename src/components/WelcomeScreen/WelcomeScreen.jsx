...
const quickQuestions = [
  ...
  { text: 'Write a Python function to parse a CSV file', subject: 'Programming' },
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div style={{
          ...
          background: 'radial-gradient(ellipse, rgba(77,124,255,0.06), transparent 70%)',
          borderRadius: '50%',
        }} />
        <div style={{
          position: 'absolute', bottom: '10%', right: '20%',
          width: 300, height: 300,
          background: 'radial-gradient(ellipse, rgba(0,212,232,0.04), transparent 70%)',
          borderRadius: '50%',
        }} />
      </div>
      ...
      <div className="w-full max-w-2xl">
        ...
        <motion.div variants={item} className="text-center mb-10">
          ...
          >
            <img src="/favi-bg.png" alt="Hif AI" className="w-10 h-10 object-contain" />
          </motion.div>
