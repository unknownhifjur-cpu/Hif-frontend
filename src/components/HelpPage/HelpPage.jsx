...
const FAQS = [
  {
    q: 'Is Hif AI completely free?',
    a: 'Yes — Hif AI is free forever. There are no hidden charges, premium tiers, or usage limits.',
  },
  {
    q: 'Do I need to create an account?',
    a: 'No. Hif AI uses a private session token stored in your browser. Your chats are linked to that token without any login.',
  },
  {
    q: 'How long are my chats stored?',
    a: 'Chats are automatically deleted after 24 hours. You can also manually delete any chat by hovering over it in the sidebar and clicking the trash icon.',
  },
  {
    q: 'Can I ask in Bengali (বাংলা)?',
    a: 'Absolutely. Hif AI is bilingual. You can write your question in বাংলা, English, or a mix of both and it will respond appropriately.',
  },
  {
    q: 'Why did the AI give a wrong answer?',
    a: 'AI can make mistakes, especially on complex or ambiguous questions. Always verify important information from authoritative sources. You can use the Regenerate button to try again.',
  },
  {
    q: 'Can I copy the AI\'s code?',
    a: 'Yes. Every code block has a Copy button in the top-right corner and a Download button in the action bar below it.',
  },
  {
    q: 'What subjects does Hif AI support?',
    a: 'Math, Science, English, Programming, History, Bengali, and General topics. Select the right subject tag before sending for a better response.',
  },
  {
    q: 'The page is not loading / something broke. What do I do?',
    a: 'Try refreshing the page. If the problem persists, clear your browser cache or contact support.',
  },
];
    ...
    >
      ...
      >
        <span
          ...
          style={{ color: open ? 'var(--text-0)' : 'var(--text-1)' }}
        >
          {item.q}
        </span>
        <motion.div
        ...
        {open && (
          ...
          >
            <p
              ...
              style={{ color: 'var(--text-2)', borderTop: '1px solid var(--border-0)', paddingTop: 12 }}
            >
              {item.a}
            </p>
          </motion.div>
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        >
          <motion.div variants={item} className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(77,124,255,0.15), rgba(0,212,232,0.1))',
          ...
          <motion.p variants={item} className="text-sm mt-4" style={{ color: 'var(--text-2)' }}>
            Welcome to the Hif AI Help Center. Find answers, learn how to use features,
        ...
        >
            ...
            return (
              <motion.button
                ...
                style={{
                  ...
                  border: `1px solid ${isActive ? s.color + '40' : 'var(--border-1)'}`,
          ...
          <motion.button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-medium transition-all"
            style={{
              background: activeSection === 'faq' ? 'rgba(74,222,128,0.08)' : 'var(--bg-3)',
              border: `1px solid ${activeSection === 'faq' ? 'rgba(74,222,128,0.35)' : 'var(--border-1)'}`,
              color: activeSection === 'faq' ? '#4ade80' : 'var(--text-2)',
            }}
          >
            <AlertCircle size={13} />
            FAQ
              ...
              <div className="flex flex-col gap-3">
                {SECTIONS[0].steps.map((step, i) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold mb-1" style={{ color: 'var(--text-0)' }}>
                        {step.title}
                      </p>
              ...
              >
                ...
                <p className="text-xs leading-relaxed" style={{ color: 'var(--text-2)' }}>
                  ...
                  <kbd
                    ...
                    style={{ background: 'var(--bg-5)', border: '1px solid var(--border-2)', color: 'var(--text-1)' }}
                  >
                    Enter
                  </kbd>{' '}
                  to send and{' '}
                  ...
                  for a new line inside the message box.
                </p>
              </motion.div>
            </motion.div>
          )}
                ...
                {SECTIONS[1].features.map((f, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs font-semibold mb-0.5" style={{ color: 'var(--text-0)' }}>
                          {f.label}
                        </p>
                        <p className="text-xs leading-relaxed" style={{ color: 'var(--text-2)' }}>
                          {f.desc}
          ...
          {activeSection === 'faq' && (
            ...
            >
              ...
              >
                ...
                />
                {faqSearch && (
                  <button onClick={() => setFaqSearch('')} style={{ color: 'var(--text-3)' }}>
                    <X size={12} />
                  </button>
                )}
              </div>
        ...
        >
          ...
          <div className="flex gap-2 flex-wrap">
            <a
              href="mailto:unknownhifjur@gmail.com"
            ...
            <a
              href="https://heartlock.vercel.app"
              target="_blank"
